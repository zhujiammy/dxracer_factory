...
import com.example.zhujia.dxracer_factory.Activity.Officegoodsdurable;
...
public class OfficegoodsdurableAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public Officegoodsdurable context;
    private int type=0;
    private SharedPreferences sharedPreferences;
    private String business_id,departmentId,departmentPersonName,departmentPersonSession;
    Map<String,String> params;
    private OfficegoodsdurableAdapter.OnitemClickListener onitemClickListener=null;
    @SuppressLint("WrongConstant")
    public OfficegoodsdurableAdapter(Officegoodsdurable context1, List<MData>data){
    ...
    public void setOnitemClickListener(OfficegoodsdurableAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.officegoodsdurable_data, parent, false);
            OfficegoodsdurableAdapter.LinearViewHolder linearViewHolder = new OfficegoodsdurableAdapter.LinearViewHolder(baseView);
            ...
            OfficegoodsdurableAdapter.GridViewHolder gridViewHolder = new OfficegoodsdurableAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final OfficegoodsdurableAdapter.LinearViewHolder linearViewHolder= (OfficegoodsdurableAdapter.LinearViewHolder) holder;
            ...
            linearViewHolder.num.setText(data.get(position).getNum());
                linearViewHolder.durableType.setText(data.get(position).getDurableType());
            linearViewHolder.price.setText(data.get(position).getPrice());
           linearViewHolder.stock.setText(data.get(position).getStocks());
          if(data.get(position).getNeedCheck()==1){
              linearViewHolder.needCheck.setText("是");
          }else {
              linearViewHolder.needCheck.setText("否");
          }
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private TextView code,name,brand,model,standard,needCheck,num,durableType,price,stock;
        ...
        public LinearViewHolder(View itemView) {
            ...
            needCheck=(TextView)itemView.findViewById(R.id.needCheck);
