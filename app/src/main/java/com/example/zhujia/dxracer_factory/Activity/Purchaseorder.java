...
import com.example.zhujia.dxracer_factory.Adapter.PurchaseorderAdapter;
...
public class Purchaseorder extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.purchaseorder);
        intent=getIntent();
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new PurchaseorderAdapter(this,getData());
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/purchase/purchaseorder/forplanlist", params, new IHttpCallBack() {
            @Override
    ...
    private void fillDataToList(JSONArray data) throws JSONException {
        ...
        for(int i=0;i<data.length();i++){
            ...
            rechargData.setOriginalPurchaseOrderNo(object.getString("originalPurchaseOrderNo"));
            rechargData.setPurchasePaymentOrder(object.getString("purchasePaymentOrder"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Purchaseorder.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
