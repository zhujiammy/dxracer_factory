...
public class EquipmentCategoryAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public EquipmentCategory context;
    private int type=0;
    ...
    private EquipmentCategoryAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public EquipmentCategoryAdapter(EquipmentCategory context1, List<MData>data){
    ...
    public void setOnitemClickListener(EquipmentCategoryAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.equipmentcategory_data, parent, false);
            EquipmentCategoryAdapter.LinearViewHolder linearViewHolder = new EquipmentCategoryAdapter.LinearViewHolder(baseView);
            ...
            EquipmentCategoryAdapter.GridViewHolder gridViewHolder = new EquipmentCategoryAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final EquipmentCategoryAdapter.LinearViewHolder linearViewHolder= (EquipmentCategoryAdapter.LinearViewHolder) holder;
            ...
            linearViewHolder.edit_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context, AddEqcategory.class);
        ...
        normalDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        params.put("id",id);
                        HttpUtility.doPostAsyn("/servlet/equipment/equipmentcategory/delete", params, new IHttpCallBack() {
                            @Override
