...
public class StockinorderAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<BatchwareData> data;
    public Stockinorder context;
    private int type=0;
    private SharedPreferences sharedPreferences;
    private String business_id,userId,departmentPersonName,departmentPersonSession;
    Map<String,String> params;
    private Handler mHandler;
    private StockinorderAdapter.OnitemClickListener onitemClickListener=null;
    @SuppressLint("WrongConstant")
    public StockinorderAdapter(Stockinorder context1, List<BatchwareData>data){
    ...
    public void setOnitemClickListener(StockinorderAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            StockinorderAdapter.LinearViewHolder linearViewHolder = new StockinorderAdapter.LinearViewHolder(baseView);
            ...
            StockinorderAdapter.GridViewHolder gridViewHolder = new StockinorderAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final StockinorderAdapter.LinearViewHolder linearViewHolder= (StockinorderAdapter.LinearViewHolder) holder;
