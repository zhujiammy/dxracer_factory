...
public class Productionplanlog extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private ProductionplanlogAdapter adapter;
    private  int total;
    private String url;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.productionplanlog);
        intent=getIntent();
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new ProductionplanlogAdapter(this,getData());
    ...
    private void loaddata(){
        ...
        },mHandler,Productionplanlog.this);
    }
                ...
                if ((null == result) || (result.equals(""))) {
                    ...
                    try
                    {
                        ...
                        if(intent.getStringExtra("type").equals("0")||intent.getStringExtra("type").equals("1")){
                            ...
                            pageindex=pageindex+1;
                            hasMoreData=true;
                            fillDataToList1(contentjsonarry);
                        }
    ...
    private void fillDataToList(JSONObject data) throws JSONException {
        ...
        for(int i=0;i<contentjsonarry.length();i++){
            ...
            rechargData.setRemark(object.getString("remark"));
            rechargData.setCreateTime(insertComma.stampToDate(object.getString("createTime")));
            rechargData.setOperator(object.getString("operator"));
    ...
    private void fillDataToList1(JSONArray data) throws JSONException {
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Productionplanlog.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
