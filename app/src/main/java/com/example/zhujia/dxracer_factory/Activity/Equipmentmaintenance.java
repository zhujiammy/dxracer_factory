...
public class Equipmentmaintenance extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private String type,status,maintenancePeopleOutId,equipmentId;
    private MyradionGroup radioGroup;
    private EditText field2;
    private TextView startTime,endTime;
    private Spinner equipment,maintenancePeopleOut;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loaddata();//加载列表数据
        getDate();//获取当前日期
        adapter=new EquipmentmaintenanceAdapter(Equipmentmaintenance.this,getData());
    }
    @SuppressLint("WrongConstant")
    ...
    private void initUI(){
        ...
        customView = View.inflate(Equipmentmaintenance.this,R.layout.equipmentmaintenance_seach, null);
        popWindow = new PopWindow.Builder(Equipmentmaintenance.this)
    ...
    private void  laodmyequipment(){
        ...
        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintenance",params,new HttpUtils.HttpCallback() {
            ...
            public void onError(String msg) {
                // TODO Auto-generated method stub
                super.onError(msg);
                Toast.makeText(Equipmentmaintenance.this, "error", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void loaddata(){
        ...
        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintenance/mylist",params,new HttpUtils.HttpCallback() {
            @Override
            public void onStart() {
                // TODO Auto-generated method stub
                super.onStart();
            ...
            public void handleMessage(Message msg) {
                ...
                try{
                    switch (msg.what) {
                        ...
                        default:
                            Toast.makeText(Equipmentmaintenance.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public void onClick(View v) {
        ...
        if(v==startTime){
            ...
            DatePickerDialog dialog=new DatePickerDialog(Equipmentmaintenance.this,DatePickerDialog.THEME_DEVICE_DEFAULT_LIGHT,listener,year,month,day);
            dialog.show();
        }
