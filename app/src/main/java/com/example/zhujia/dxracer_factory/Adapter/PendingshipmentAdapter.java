...
public class PendingshipmentAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<BatchwareData> data;
    public Pendingshipment context;
    private int type=0;
    ...
    private PendingshipmentAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public PendingshipmentAdapter(Pendingshipment context1, List<BatchwareData>data){
    ...
    public void setOnitemClickListener(PendingshipmentAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.pendingshipment_data, parent, false);
            PendingshipmentAdapter.LinearViewHolder linearViewHolder = new PendingshipmentAdapter.LinearViewHolder(baseView);
            ...
            PendingshipmentAdapter.GridViewHolder gridViewHolder = new PendingshipmentAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final PendingshipmentAdapter.LinearViewHolder linearViewHolder= (PendingshipmentAdapter.LinearViewHolder) holder;
            linearViewHolder.productDate.setText(data.get(position).getProductDate());
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private TextView productDate,fcno,quantity,materialNo,productionOrderNo,orderNo,status,materialTime,score,outputTime;
