...
public class EquipmentsupplierAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public Equipmentsupplier context;
    private int type=0;
    ...
    private EquipmentsupplierAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public EquipmentsupplierAdapter(Equipmentsupplier context1, List<MData>data){
    ...
    public void setOnitemClickListener(EquipmentsupplierAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.equipmentsupplier_data, parent, false);
            EquipmentsupplierAdapter.LinearViewHolder linearViewHolder = new EquipmentsupplierAdapter.LinearViewHolder(baseView);
            ...
            EquipmentsupplierAdapter.GridViewHolder gridViewHolder = new EquipmentsupplierAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final EquipmentsupplierAdapter.LinearViewHolder linearViewHolder= (EquipmentsupplierAdapter.LinearViewHolder) holder;
            linearViewHolder.supplierCode.setText(data.get(position).getSupplierCode());
            linearViewHolder.supplierName.setText(data.get(position).getSupplierName());
            linearViewHolder.supplierAddress.setText(data.get(position).getSupplierAddress());
            linearViewHolder.supplierTel.setText(data.get(position).getSupplierTel());
            linearViewHolder.supplierConPerson.setText(data.get(position).getSupplierConPerson());
            linearViewHolder.supplierConPersonTel.setText(data.get(position).getSupplierConPersonTel());
            ...
            if(!data.get(position).getField2().equals("null")){
                linearViewHolder.field2.setText(data.get(position).getField2());
            }else {
                linearViewHolder.field2.setText("-");
            }
            if(!data.get(position).getField3().equals("null")){
                linearViewHolder.field3.setText(data.get(position).getField3());
            }else {
                linearViewHolder.field3.setText("-");
            }
            if(!data.get(position).getField4().equals("null")){
                linearViewHolder.field4.setText(data.get(position).getField4());
            }else {
                linearViewHolder.field4.setText("-");
            }

            if(data.get(position).getStatus().equals("Y")){
                linearViewHolder.status.setText("正常");
            }else {
                linearViewHolder.status.setText("停用");
            }
            ...
            linearViewHolder.edit_btn.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("supplierCode",data.get(position).getSupplierCode());
                    intent.putExtra("supplierName",data.get(position).getSupplierName());
                    intent.putExtra("supplierAddress",data.get(position).getSupplierAddress());
                    intent.putExtra("supplierTel",data.get(position).getSupplierTel());
                    intent.putExtra("supplierConPerson",data.get(position).getSupplierConPerson());
                    intent.putExtra("supplierConPersonTel",data.get(position).getSupplierConPersonTel());
                    intent.putExtra("field1",data.get(position).getField1());
                    intent.putExtra("field2",data.get(position).getField2());
                    intent.putExtra("field3",data.get(position).getField3());
        ...
        normalDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        params.put("id",id);
                        HttpUtility.doPostAsyn("/servlet/equipment/equipmentsupplier/delete", params, new IHttpCallBack() {
                            @Override
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private TextView supplierCode,supplierName,supplierAddress,supplierTel,supplierConPerson,supplierConPersonTel,field1,field2,field3,field4,status;
        private LinearLayout lin,confirmTimelin;
        private Button edit_btn,del_btn;
        public LinearViewHolder(View itemView) {
            super(itemView);
            supplierCode=(TextView)itemView.findViewById(R.id.supplierCode);
            supplierName=(TextView)itemView.findViewById(R.id.supplierName);
            supplierAddress=(TextView)itemView.findViewById(R.id.supplierAddress);
            supplierTel=(TextView)itemView.findViewById(R.id.supplierTel);
            supplierConPerson=(TextView)itemView.findViewById(R.id.supplierConPerson);
            supplierConPersonTel=(TextView)itemView.findViewById(R.id.supplierConPersonTel);
