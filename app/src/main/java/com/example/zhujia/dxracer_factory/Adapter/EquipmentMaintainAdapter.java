...
public class EquipmentMaintainAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public EquipmentMaintain context;
    private int type=0;
    ...
    private EquipmentMaintainAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public EquipmentMaintainAdapter(EquipmentMaintain context1, List<MData>data){
    ...
    public void setOnitemClickListener(EquipmentMaintainAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.equipmentmaintain_data, parent, false);
            EquipmentMaintainAdapter.LinearViewHolder linearViewHolder = new EquipmentMaintainAdapter.LinearViewHolder(baseView);
            ...
            EquipmentMaintainAdapter.GridViewHolder gridViewHolder = new EquipmentMaintainAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final EquipmentMaintainAdapter.LinearViewHolder linearViewHolder= (EquipmentMaintainAdapter.LinearViewHolder) holder;
            ...
            linearViewHolder.edit_btn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context.getApplicationContext(), EditformB.class);
                    String id= String.valueOf(data.get(position).getId());
