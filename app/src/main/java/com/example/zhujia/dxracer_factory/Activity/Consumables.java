...
public class Consumables extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/material/consumables/item/list", params, new IHttpCallBack() {
            @Override
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Consumables.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
