...
public class Myequipment extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private TextView text,text_btn,content,equipmentUseTime;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loaddata();//加载列表数据
        getDate();//获取当前日期
        adapter=new MyequipmentAdapter(Myequipment.this,getData());
    ...
    private void initUI(){
        ...
        customView = View.inflate(Myequipment.this,R.layout.equipment_seachs, null);
        popWindow = new PopWindow.Builder(Myequipment.this)
    ...
    private void  laodmyequipment(){
        ...
        HttpUtility.doPostAsyn("/servlet/equipment/equipment", params, new IHttpCallBack() {
            @Override
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/equipment/equipment/mylist", params, new IHttpCallBack() {
            @Override
            public void onRequestComplete(String result, Handler handler, String errcode) {
                if ((null == result) || (result.equals(""))) {
                    // 网络连接异常
    ...
    private void initItemMoreData() {
        ...
        params.put("equipmentManager",departmentPersonId);
        if(status==null){
            params.put("equipmentStatus",departmentPersonId);
        }else {
            params.put("equipmentStatus",status);
        }
        HttpUtility.doPostAsyn("/servlet/equipment/equipment/mylist", params, new IHttpCallBack() {
            ...
            public void handleMessage(Message msg) {
                ...
                try{
                    switch (msg.what) {
                        ...
                        default:
                            Toast.makeText(Myequipment.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public void onClick(View v) {
        ...
        if(v==equipmentUseTime){
            ...
            DatePickerDialog dialog=new DatePickerDialog(Myequipment.this,DatePickerDialog.THEME_DEVICE_DEFAULT_LIGHT,listener,year,month,day);
            dialog.show();
        }
