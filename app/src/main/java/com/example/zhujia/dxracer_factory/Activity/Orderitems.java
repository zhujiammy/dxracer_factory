...
import com.example.zhujia.dxracer_factory.Adapter.OrderitemsAdapter;
...
public class Orderitems extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private List<SpotData> mListData=new ArrayList<>();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new OrderitemsAdapter(this,getData());
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Orderitems.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
