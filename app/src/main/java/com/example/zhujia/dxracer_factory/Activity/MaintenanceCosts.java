...
public class MaintenanceCosts extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.maintenancecosts);
    ...
    private void loadeditMoney(){
        ...
        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintenance/editMoney/inittext",params,new HttpUtils.HttpCallback() {
        ...
        if(id==R.id.save_btn){
           ...
           if(TextUtils.isEmpty(cost.getText().toString())){
               ...
               Log.e("TAG", "onOptionsItemSelected: "+params );
                new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintenancedetail/add",params,new HttpUtils.HttpCallback() {
    ...
    private void showNormalDialog(final String id){
        ...
        final AlertDialog.Builder normalDialog =
                new AlertDialog.Builder(MaintenanceCosts.this);
