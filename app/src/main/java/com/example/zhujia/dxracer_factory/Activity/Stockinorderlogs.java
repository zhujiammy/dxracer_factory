...
public class Stockinorderlogs extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/stock/stockinorderlog/log/list", params, new IHttpCallBack() {
            @Override
        ...
        },mHandler,Stockinorderlogs.this);
    }
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Stockinorderlogs.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
