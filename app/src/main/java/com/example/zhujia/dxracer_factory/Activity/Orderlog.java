...
public class Orderlog extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/order/orderlog/log/list", params, new IHttpCallBack() {
            @Override
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Orderlog.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
