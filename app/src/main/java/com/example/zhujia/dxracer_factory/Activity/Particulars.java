...
import com.example.zhujia.dxracer_factory.Adapter.ParticularsAdapter;
...
public class Particulars extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new ParticularsAdapter(this,getData());
    ...
    private void loaddata(){
        ...
        params.put("productionOrderId",intent.getStringExtra("productionOrderId"));
        HttpUtility.doPostAsyn("/servlet/productionconfig/productionorderwages/list", params, new IHttpCallBack() {
            @Override
    ...
    private void initItemMoreData() {
        ...
        params.put("orderNo",intent.getStringExtra("orderNo"));
        HttpUtility.doPostAsyn("/servlet/productionconfig/productionorderwages/list", params, new IHttpCallBack() {
            @Override
            public void onRequestComplete(String result, Handler handler, String errcode) {
                if ((null == result) || (result.equals(""))) {
                    ...
                    try
                    {
                        ...
                        contentjsonarry=contentjsonobject.getJSONArray("holidayStr");
    ...
    private void fillDataToList(JSONArray data) throws JSONException {
        ...
        for(int i=0;i<data.length();i++){
            ...
            rechargData.setCraftName(object.getString("craftName"));
            rechargData.setUnitPrice(object.getString("unitPrice"));
            rechargData.setOvertimePay(object.getString("overtimePay"));
            rechargData.setQuantity(object.getString("quantity"));
            JSONObject person=object.getJSONObject("person");
            rechargData.setPersonCode(person.getString("personCode"));
            rechargData.setRealName(person.getString("realName"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Particulars.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
