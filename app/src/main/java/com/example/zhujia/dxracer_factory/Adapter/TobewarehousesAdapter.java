...
public class TobewarehousesAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public Tobewarehouses context;
    private int type=0;
    private SharedPreferences sharedPreferences;
    private String business_id,departmentId,departmentPersonName,departmentPersonSession;
    Map<String,String> params;
    private TobewarehousesAdapter.OnitemClickListener onitemClickListener=null;
    @SuppressLint("WrongConstant")
    public TobewarehousesAdapter(Tobewarehouses context1, List<MData>data){
    ...
    public void setOnitemClickListener(TobewarehousesAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.tobewarehouses_data, parent, false);
            TobewarehousesAdapter.LinearViewHolder linearViewHolder = new TobewarehousesAdapter.LinearViewHolder(baseView);
            ...
            TobewarehousesAdapter.GridViewHolder gridViewHolder = new TobewarehousesAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final TobewarehousesAdapter.LinearViewHolder linearViewHolder= (TobewarehousesAdapter.LinearViewHolder) holder;
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private TextView storageNo,fcno,quantity,productionOrderNo,pickOrderNo,orderNo;
