...
import com.example.zhujia.dxracer_factory.Adapter.PersonAddressAdapter;
...
public class PersonAddress extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new PersonAddressAdapter(PersonAddress.this,getData());
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/organization/departmentpersonaddress/list", params, new IHttpCallBack() {
            @Override
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(PersonAddress.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
