...
public class Materialorderitem extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private void loaddata(){
        ...
        params.put("materialOrderId",intent.getStringExtra("materialOrderId"));
        params.put("page", String.valueOf(pageindex));
        HttpUtility.doPostAsyn("/servlet/material/materialorderitem/list", params, new IHttpCallBack() {
            @Override
        ...
        },mHandler,Materialorderitem.this);
    }
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Materialorderitem.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
