...
public class EquipmentMaintain extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loaddata();//加载列表数据
        getDate();//获取当前日期
        adapter=new EquipmentMaintainAdapter(EquipmentMaintain.this,getData());
    }
    @SuppressLint("WrongConstant")
    ...
    private void initUI(){
        ...
        customView = View.inflate(EquipmentMaintain.this,R.layout.equipmentmaintain_seach, null);
        popWindow = new PopWindow.Builder(EquipmentMaintain.this)
    ...
    private void loaddata(){
        ...
        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintain/mylist",params,new HttpUtils.HttpCallback() {
            @Override
            public void onStart() {
                // TODO Auto-generated method stub
                super.onStart();
            ...
            public void onError(String msg) {
                // TODO Auto-generated method stub
                super.onError(msg);
                Toast.makeText(EquipmentMaintain.this, "error", Toast.LENGTH_LONG).show();
            }
        });
    }
            ...
            public void handleMessage(Message msg) {
                ...
                try{
                    switch (msg.what) {
                        ...
                        default:
                            Toast.makeText(EquipmentMaintain.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public void onClick(View v) {
        ...
        if(v==startTime){
            ...
            DatePickerDialog dialog=new DatePickerDialog(EquipmentMaintain.this,DatePickerDialog.THEME_DEVICE_DEFAULT_LIGHT,listener,year,month,day);
            dialog.show();
        }
