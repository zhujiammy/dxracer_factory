...
public class AllEquipmentMaintainAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<MData> data;
    public AllEquipmentMaintain context;
    private int type=0;
    ...
    private AllEquipmentMaintainAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public AllEquipmentMaintainAdapter(AllEquipmentMaintain context1, List<MData>data){
    ...
    public void setOnitemClickListener(AllEquipmentMaintainAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            baseView = LayoutInflater.from(parent.getContext()).inflate(R.layout.allequipmentmaintain_data, parent, false);
            AllEquipmentMaintainAdapter.LinearViewHolder linearViewHolder = new AllEquipmentMaintainAdapter.LinearViewHolder(baseView);
            ...
            AllEquipmentMaintainAdapter.GridViewHolder gridViewHolder = new AllEquipmentMaintainAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final AllEquipmentMaintainAdapter.LinearViewHolder linearViewHolder= (AllEquipmentMaintainAdapter.LinearViewHolder) holder;

            linearViewHolder.maintainNo.setText(data.get(position).getMaintainNo());
            ...
            if(data.get(position).getMainContent().equals("null")){
                linearViewHolder.mainContent.setText("-");
            }else {
                linearViewHolder.mainContent.setText(data.get(position).getMainContent());
            }
            if(data.get(position).getContent().equals("null")){
                linearViewHolder.content.setText("-");
            }else {
                linearViewHolder.content.setText(data.get(position).getContent());
            }
            linearViewHolder.field1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context, PhotoView.class);
                    intent.putExtra("photoview",data.get(position).getField1());
            ...
            linearViewHolder.check.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context.getApplicationContext(), EquipmentMaintaincheck.class);
                    String id= String.valueOf(data.get(position).getId());
                    intent.putExtra("id",id);
                    intent.putExtra("MaintainNo",data.get(position).getMaintainNo());
            ...
            linearViewHolder.add.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context.getApplicationContext(), MaintenanCosts.class);
                    String id= String.valueOf(data.get(position).getId());
                    intent.putExtra("id",id);
                    intent.putExtra("MaintainNo",data.get(position).getMaintainNo());
                    context.startActivity(intent);
            ...
            linearViewHolder.confirm.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context.getApplicationContext(), MaintenanConfirm.class);
                    String id= String.valueOf(data.get(position).getId());
                    intent.putExtra("id",id);
                    intent.putExtra("MaintainNo",data.get(position).getMaintainNo());
                    intent.putExtra("mainContent",data.get(position).getMainContent());
            ...
            linearViewHolder.Invoice.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(context.getApplicationContext(), ApplyPayments.class);
                    String id= String.valueOf(data.get(position).getId());
                    intent.putExtra("id",id);
                    intent.putExtra("MaintainNo",data.get(position).getMaintainNo());
                    intent.putExtra("field2",data.get(position).getField2());
        ...
        normalDialog.setPositiveButton("确定",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintain/delete",params,new HttpUtils.HttpCallback() {
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private TextView maintainNo,equipmentNo,equipmentName,startTime,mainContent,content,field1,field3,field2,paymentStatus,supplierName,realName,endTime,checkName,total,status;
        private LinearLayout lin,confirmTimelin;
        private Button check,add,confirm,Invoice;
        public LinearViewHolder(View itemView) {
            super(itemView);
            maintainNo=(TextView)itemView.findViewById(R.id.maintainNo);
