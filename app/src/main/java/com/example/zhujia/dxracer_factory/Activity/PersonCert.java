...
public class PersonCert extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initUI();
        loaddata();//加载列表数据
        adapter=new PersonCertAdapter(PersonCert.this,getData());
    ...
    private void loaddata(){
        ...
        HttpUtility.doPostAsyn("/servlet/organization/departmentpersoncert/list", params, new IHttpCallBack() {
            @Override
    ...
    private void fillDataToList(JSONObject data) throws JSONException {
        ...
        for(int i=0;i<contentjsonarry.length();i++){
            ...
            rechargData.setFieldUrl(object.getString("fieldUrl"));
            JSONObject configCert=object.getJSONObject("configCert");
            rechargData.setFieltype(configCert.getString("fieldType"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(PersonCert.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
