...
import com.example.zhujia.dxracer_factory.Activity.Spotwarehousing;
...
public class SpotwarehousingAdapter extends BaseRecyclerAdapter<BaseRecyclerAdapter.BaseRecyclerViewHolder> implements View.OnClickListener  {

    private List<BatchwareData> data;
    public Spotwarehousing context;
    private int type=0;
    ...
    private SpotwarehousingAdapter.OnitemClickListener onitemClickListener=null;
    ...
    public SpotwarehousingAdapter(Spotwarehousing context1, List<BatchwareData>data){
    ...
    public void setOnitemClickListener(SpotwarehousingAdapter.OnitemClickListener onitemClickListener) {
    ...
    public BaseRecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == 0) {
            ...
            SpotwarehousingAdapter.LinearViewHolder linearViewHolder = new SpotwarehousingAdapter.LinearViewHolder(baseView);
            ...
            SpotwarehousingAdapter.GridViewHolder gridViewHolder = new SpotwarehousingAdapter.GridViewHolder(baseView);
            baseView.setOnClickListener(this);
    ...
    public void onBindViewHolder(BaseRecyclerViewHolder holder, final int position) {
        if (type==0){
            final SpotwarehousingAdapter.LinearViewHolder linearViewHolder= (SpotwarehousingAdapter.LinearViewHolder) holder;
            ...
            linearViewHolder.confirmTime.setText(data.get(position).getConfirmTime());
            ...
            linearViewHolder.lins.setVisibility(View.GONE);
            linearViewHolder.lins2.setVisibility(View.GONE);
    ...
    public static class LinearViewHolder extends BaseRecyclerViewHolder {
        ...
        private LinearLayout lin,lins,lins2;
        ...
        public LinearViewHolder(View itemView) {
            ...
            lins=(LinearLayout)itemView.findViewById(R.id.lins);
            lins2=(LinearLayout)itemView.findViewById(R.id.lins2);
        }
    }
