...
public class Stockinorderlog extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 5:
                            ...
                            break;
                        default:
                            Toast.makeText(Stockinorderlog.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
