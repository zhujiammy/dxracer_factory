...
public class AllEquipmentMaintain extends AppCompatActivity implements View.OnClickListener,OnRefreshListener,OnLoadMoreListener {
    ...
    private AllEquipmentMaintainAdapter adapter;
    private  int total;
    ...
    private EditText maintainNo,checkName;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        loaddata();//加载列表数据
        getDate();//获取当前日期
        adapter=new AllEquipmentMaintainAdapter(AllEquipmentMaintain.this,getData());
    }
    @SuppressLint("WrongConstant")
    ...
    private void initUI(){
        ...
        customView = View.inflate(AllEquipmentMaintain.this,R.layout.equipmentmaintain_seach, null);
        popWindow = new PopWindow.Builder(AllEquipmentMaintain.this)
        ...
        maintainNo=(EditText)customView.findViewById(R.id.maintainNo);
        ...
        checkName=(EditText)customView.findViewById(R.id.checkName);
    ...
    private void selectRadioBtn(){
        ...
        if(rb!=null){
            ...
            else if(rb.getText().toString().equals("保养成功")){
                status="D";
            }
            else if(rb.getText().toString().equals("保养失败")){
                status="E";
            }
    ...
    private void loaddata(){
        ...
        params.put("maintainNo",maintainNo.getText().toString());
        params.put("checkName",checkName.getText().toString());
        ...
        new HttpUtils().post(Constant.APPURLS+"/servlet/equipment/equipmentmaintain/list",params,new HttpUtils.HttpCallback() {
            @Override
            public void onStart() {
                // TODO Auto-generated method stub
                super.onStart();
            ...
            public void onError(String msg) {
                // TODO Auto-generated method stub
                super.onError(msg);
                Toast.makeText(AllEquipmentMaintain.this, "error", Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    private void fillDataToList(JSONObject data) throws JSONException {
        ...
        if(!data.isNull("rows")){
            ...
            for(int i=0;i<contentjsonarry.length();i++){
                ...
                rechargData.setMaintainNo(object.getString("maintainNo"));
                ...
                rechargData.setMainContent(object.getString("mainContent"));
                ...
                try{
                    switch (msg.what) {
                        ...
                        case 2:
                            ...
                            dicts3.add(new AllData("0","全部发起人"));
                            ...
                            for(int i=0;i<departmentPersonList.length();i++){
                                JSONObject object=departmentPersonList.getJSONObject(i);
                                dicts3.add(new AllData(object.getString("id"),object.getString("realName")));
                        ...
                        default:
                            Toast.makeText(AllEquipmentMaintain.this, "网络异常", Toast.LENGTH_SHORT).show();
                            break;
                    }
                }catch (JSONException e){
                    e.printStackTrace();
    ...
    public void onClick(View v) {
        ...
        if(v==startTime){
            ...
            DatePickerDialog dialog=new DatePickerDialog(AllEquipmentMaintain.this,DatePickerDialog.THEME_DEVICE_DEFAULT_LIGHT,listener,year,month,day);
            dialog.show();
        }
